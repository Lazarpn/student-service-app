...
export class UtilityService {
  ...
  addFadeInAnimation(element: HTMLElement, offsetInPx: number = 0) {
    const container = document.querySelector('ss-root') as HTMLElement;
  ...
  errorsForField(fieldName: string, fieldSpecificErrors: string[], errorMessages: any, form: NgForm | null = null): any {
    const errors: any = [];
